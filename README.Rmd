...
Given quantum numbers and a set of spherical coordinates, the $\Psi$ value of the hydrogen wave function can be calculated with the following function:
